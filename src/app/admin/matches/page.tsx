    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 relative pb-20">
                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between font-sans">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-xl font-black text-white tracking-tight">MATCH <span className="text-indigo-500">MANAGEMENT</span></h1>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <span className="uppercase tracking-widest text-[10px]">{syncing ? "Syncing..." : "Global Sync"}</span>
                    </button>
                </div>
            </header>

            {/* Ambient Background Glows */}
            <div className="absolute top-0 right-0 w-[800px] h-[500px] bg-indigo-600/10 blur-[150px] rounded-full pointer-events-none z-0" />

            <div className="max-w-7xl mx-auto px-4 pt-12 relative z-10">
                <p className="text-slate-400 font-medium">Control fixtures, sync API data, and manage player slot assignments.</p>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 mt-10">
                ...
                {loading ? (
                    <div className="max-w-7xl mx-auto px-4 mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 relative z-10">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="h-64 bg-slate-900/40 border border-white/5 rounded-[32px] animate-pulse" />
                        ))}
                    </div>
                ) : activeMatches.length === 0 ? (
                    <div className="max-w-7xl mx-auto px-4 mt-8 text-center py-32 bg-slate-950/40 border border-dashed border-white/10 rounded-[40px] backdrop-blur-md">
                    ...
                    <div className="max-w-7xl mx-auto px-4 mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 animate-in fade-in duration-500" key={activeTab}>
