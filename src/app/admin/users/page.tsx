...
import { Users as UsersIcon, ShieldCheck, UserPlus, Clock, Mail } from "lucide-react";
...
export default async function AdminUsersPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500 relative pb-10 mt-2">
            {/* Subtler Ambient Background Glow */}
            <div className="absolute -top-20 right-0 w-[600px] h-[400px] bg-indigo-600/5 blur-[120px] rounded-full pointer-events-none z-0" />
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-950/20 p-6 rounded-[24px] border border-white/5 backdrop-blur-xl shadow-xl">
                <div>
                    ...
                    <p className="text-slate-500 mt-1 text-sm font-medium">Coordinate platform access, assign roles, and maintain safety.</p>
                </div>
