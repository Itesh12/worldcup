...
export default function AdminDashboardPage() {
    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 relative pb-20">
            ...
            <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-indigo-600/10 blur-[150px] rounded-full pointer-events-none z-0" />
            <div className="absolute top-[400px] -right-20 w-[600px] h-[600px] bg-purple-600/5 blur-[120px] rounded-full pointer-events-none z-0" />
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-400 mt-3 text-lg font-medium max-w-2xl">
                        Real-time analytics and performance monitoring for the World Cup portal.
                    </p>
                </div>
